    ...
    <section class="block sm:flex bg-white px-4 sm:px-8 py-4">
        <div class="flex-1">
            ...
            <div class="grid gap-6 grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="px-4 flex flex-col justify-between leading-normal">
                        <div class="mb-8">
                            <div class="text-black font-bold text-xl mb-2">
                                <a class="hover:text-orange" href="{{route('salons')}}">Салон на братиславской</a>
                            </div>
                ...
                <div class="w-full flex">
                    <div class="h-48 lg:h-auto w-32 xl:w-48 flex-none text-center rounded-lg overflow-hidden">
                        <a class="block w-full h-full hover:opacity-75" href="{{route('salons')}}"><img src="assets/pictures/test_salon_2.jpg" class="w-full h-full object-cover" alt=""></a>
                    </div>
                    <div class="px-4 flex flex-col justify-between leading-normal">
                        <div class="mb-8">
                            <div class="text-black font-bold text-xl mb-2">
